...
ir_operand _sys_jit(ssa_emit_context* ctx, uint64_t reg_id) {
    ...
    switch (reg_id) {
    case nzcv_n:
        return ir_operand::copy_new_raw_size(aarch64_emit_context::get_context_reg_raw(actx, offsets.n_offset), int64);
    case nzcv_z:
        return ir_operand::copy_new_raw_size(aarch64_emit_context::get_context_reg_raw(actx, offsets.z_offset), int64);
    case nzcv_c:
        return ir_operand::copy_new_raw_size(aarch64_emit_context::get_context_reg_raw(actx, offsets.c_offset), int64);
    case nzcv_v:
        return ir_operand::copy_new_raw_size(aarch64_emit_context::get_context_reg_raw(actx, offsets.v_offset), int64);
    case fpcr:
        return aarch64_emit_context::get_context_reg_raw(actx, offsets.fpcr_offset);
    case fpsr:
        return aarch64_emit_context::get_context_reg_raw(actx, offsets.fpsr_offset);
    case exclusive_address:
        return aarch64_emit_context::get_context_reg_raw(actx, offsets.exclusive_address_offset);
    case exclusive_value:
        return aarch64_emit_context::get_context_reg_raw(actx, offsets.exclusive_value_offset);
    case thread_local_0:
        return aarch64_emit_context::get_context_reg_raw(actx, offsets.thread_local_0);
    case thread_local_1:
        return aarch64_emit_context::get_context_reg_raw(actx, offsets.thread_local_1);
    default:
        throw_error();
    }
}
...
void _sys_jit(ssa_emit_context* ctx, uint64_t reg_id, ir_operand value) {
    ...
    switch (reg_id) {
    case nzcv_n:
        aarch64_emit_context::set_context_reg_raw(actx, offsets.n_offset, value);
        break;
    case nzcv_z:
        aarch64_emit_context::set_context_reg_raw(actx, offsets.z_offset, value);
        break;
    case nzcv_c:
        aarch64_emit_context::set_context_reg_raw(actx, offsets.c_offset, value);
        break;
    case nzcv_v:
        aarch64_emit_context::set_context_reg_raw(actx, offsets.v_offset, value);
        break;
    case fpcr:
        aarch64_emit_context::set_context_reg_raw(actx, offsets.fpcr_offset, value);
        break;
    case fpsr:
        aarch64_emit_context::set_context_reg_raw(actx, offsets.fpsr_offset, value);
        break;
    case exclusive_address:
        aarch64_emit_context::set_context_reg_raw(actx, offsets.exclusive_address_offset, value);
        break;
    case exclusive_value:
        aarch64_emit_context::set_context_reg_raw(actx, offsets.exclusive_value_offset, value);
        break;
    case thread_local_0:
        aarch64_emit_context::set_context_reg_raw(actx, offsets.thread_local_0, value);
        break;
    case thread_local_1:
        aarch64_emit_context::set_context_reg_raw(actx, offsets.thread_local_1, value);
        break;
...
void call_supervisor_jit(ssa_emit_context* ctx, uint64_t svc) {
    ...
    ir_operation_block::emitds(ctx->ir, ir_external_call, ssa_emit_context::create_local(ctx, int64), ir_operand::create_con((uint64_t)process->svc_function), actx->context_pointer, ir_operand::create_con(svc));
...
void undefined_jit(ssa_emit_context* ctx) {
    throw_error();
};
...
static ir_operand x86_add_subtract_set_flags_jit(ssa_emit_context* ctx, uint64_t O, ir_operand n, ir_operand m, bool is_add) {
    ...
    ir_operand destinations[] = {
        result, aarch64_emit_context::get_context_reg_raw(actx, offsets.n_offset), aarch64_emit_context::get_context_reg_raw(actx, offsets.z_offset), aarch64_emit_context::get_context_reg_raw(actx, offsets.c_offset), aarch64_emit_context::get_context_reg_raw(actx, offsets.v_offset),
    };

    ir_operand sources[] = {n, m};
