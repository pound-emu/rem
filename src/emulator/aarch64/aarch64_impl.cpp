	...
	{
		{
			...
			if ((((uint64_t)((uint64_t)((uint64_t)((uint64_t)opc == (uint64_t)2ULL) && (uint64_t)((uint64_t)N == (uint64_t)sf)) && (uint64_t)((uint64_t)imms != (uint64_t)(((uint64_t)31ULL | (uint64_t)(((uint64_t)sf << (uint64_t)5ULL)))))) && (uint64_t)(((uint64_t)((uint64_t)imms + (uint64_t)1ULL) == (uint64_t)immr)))))
			{
